...
@section('body')
    ...
    <div class="container">&nbsp
        <h3 style="color:grey">问题添加：</h3><br>
        ...
        @if ($errors->any())
            ...
            @endforeach
        @endif
        <form class="form-horizontal" action="{{url('admin/add_questions_do')}}" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-md-5">
                    <input type="text" name="q_title" class="form-control" placeholder="请输入问题标题">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10 col-md-5" id="show">
                    <!-- 加载编辑器的容器 -->
                    <script id="container" name="q_content" type="text/plain" style="height:300px;"></script>
                </div>
            </div>
